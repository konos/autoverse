...
**Plans**: 3/5 plans executed (2026-08-27 계획 — 트레이서 선행 + 웨이브 4단계)
...
- [ ] 07-04-PLAN.md — [wave 4] LoginPanel 이메일 프리필 · 저장 비밀번호 로그인 버튼 · 저장 상태문 · 로그인 상태 무관 삭제 버튼 (D-02/D-03/D-04/D-06/D-07, R023)
...
| 07. API 자격 증명 저장 + 토큰 만료 사전 경고 | v0.3.0 | 3/5 | In Progress|  |
