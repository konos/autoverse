...
**Plans**: 3/7 plans executed (2026-08-26 계획 — 트레이서 선행 + 웨이브 5단계)
**UI hint**: yes
...
- [ ] 06-04-PLAN.md — [wave 2] 반증된 계정 API 로그인 코드 제거 + 자격증명 로그인 단일 경로 확정 + 무인 자동 로그인 가드 재정의 (D-01/D-02/D-03)

**Wave 3** *(06-04 완료 후)*

- [ ] 06-05-PLAN.md — [wave 3] 캡차 오분류 수정 + 실패 사유·마스킹된 식별자 종단 배선 (D-13/D-12, R010 관문)
...
| 06. 로그인 방식 선택 UI + 실패 안내 | v0.3.0 | 3/7 | In Progress|  |
