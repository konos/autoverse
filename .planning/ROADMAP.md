...
**Plans**: 5 plans (2026-08-27 계획 — 트레이서 선행 + 웨이브 4단계)

**Wave 1**

- [ ] 07-01-PLAN.md — [wave 1] **트레이서**: 만료 판정 종단 슬라이스(`src/shared/token-expiry.ts` → `arm()` 판정 → `apply:event` → 대기 화면 인라인 경고 + 재로그인 진입점) (D-08/D-09/D-10/D-11/D-12/D-15, R022)
...
| 07. API 자격 증명 저장 + 토큰 만료 사전 경고 | v0.3.0 | 0/5 | Planned | - |
