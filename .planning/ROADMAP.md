...
**Plans**: 1/5 plans executed (2026-08-27 계획 — 트레이서 선행 + 웨이브 4단계)
...
- [ ] 07-02-PLAN.md — [wave 2] 이메일 마스킹 관문 신설 + `credentials.enc` 4상태 읽기 + 이메일 불일치 메인 게이트 + 재로그인 실패 시 토큰 복원 (D-01/D-03/D-04/D-07/D-14, R023·R022)
...
| 07. API 자격 증명 저장 + 토큰 만료 사전 경고 | v0.3.0 | 1/5 | In Progress|  |
